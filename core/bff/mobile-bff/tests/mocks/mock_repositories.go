...
func (m *MockPokemonRepository) GetFavorites(_ context.Context, _ string, _, _ int) ([]string, error) {
	return []string{}, nil
}

func (m *MockPokemonRepository) ListTypes(_ context.Context) ([]domain.Type, error) {
	return []domain.Type{
...
func (m *MockPokemonRepository) ListRegions(_ context.Context) ([]domain.Region, error) {
...
// MockFavoriteRepository implementa FavoriteRepository em memória.
...
func (m *MockFavoriteRepository) AddFavorite(_ context.Context, userID, pokemonID string) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MockFavoriteRepository) RemoveFavorite(_ context.Context, userID, pokemonID string) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MockFavoriteRepository) IsFavorite(_ context.Context, userID, pokemonID string) (bool, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *MockFavoriteRepository) GetUserFavorites(_ context.Context, userID string) ([]string, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
