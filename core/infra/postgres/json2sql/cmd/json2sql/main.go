...
import (
	...
	"pokedex-platform/core/infra/postgres/json2sql/internal/loader"
	"pokedex-platform/core/infra/postgres/json2sql/internal/mapper"
	"pokedex-platform/core/infra/postgres/json2sql/internal/preflight"
	"pokedex-platform/core/infra/postgres/json2sql/internal/special"
	"pokedex-platform/core/infra/postgres/json2sql/internal/writer"
)

func main() {
	input := flag.String("input", "core/infra/postgres/source-json", "directory with source JSON files")
	output := flag.String("output", "core/infra/postgres/seeds/init-data.sql", "output SQL file path")
