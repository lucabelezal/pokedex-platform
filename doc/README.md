...
- [architecture/test-doubles-go-como-funciona.md](architecture/test-doubles-go-como-funciona.md): **test doubles em Go com código real do projeto** — stub, fake, spy, mock, dummy; `httptest` para adapters; e a decisão `tests/` separado vs testes co-localizados.
